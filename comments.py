...
def Task_23(start,end,multi=[9999],plus=[0],inc=[-1],ex=[-1]):
	#Использование: print(Task_23(начальное значение, конечное значение, multi=[числа, на которые умножаются], plus=[которые прибавляются], inc=[обязательные в траекториии], ex=[сключаемые значения]))
